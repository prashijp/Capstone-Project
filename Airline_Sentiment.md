...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-16-2.png)<!-- -->
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-18-2.png)<!-- -->
### Tweets by Airlines
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-26-1.png)<!-- -->
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-27-1.png)<!-- -->
United Airlines has the most negative tweets among all the other airlines followed by American and Southwest. It would be interesting to find out the reson behind these negative tweets. 
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
# Bigrams and Trigrams of Sentiments 
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-29-1.png)<!-- -->
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-29-2.png)<!-- -->
#### Analysis of Variance of the sentiments 
Creating a numeric variable for polarity. polarity_score is -1 for negative sentiment, 0 for neutral and 1 for positive sentiment 
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-30-1.png)<!-- -->
...
## sentiment_variance$airline     5    160   32.05   85.33 <2e-16 ***
## Residuals                  14634   5497    0.38                   
## ---
...
![](Airline_Sentiment_files/figure-html/unnamed-chunk-30-2.png)<!-- -->
